            ...
            <footer className="py-20 border-t border-white/5 bg-dark-bg">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div>
                            <div className="flex items-center gap-2 font-black text-xl tracking-tighter mb-4">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                <li><button onClick={() => navigate('/lessons')} className="hover:text-white transition-colors">Lesson Planner</button></li>
                                <li><button onClick={() => navigate('/marking')} className="hover:text-white transition-colors">Paper Scanner</button></li>
                                <li><button onClick={() => navigate('/exams')} className="hover:text-white transition-colors">Exam Builder</button></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                <li><button onClick={() => navigate('/admin')} className="hover:text-white transition-colors">Admin Dashboard</button></li>
                                <li><button onClick={() => navigate('/dashboard')} className="hover:text-white transition-colors">Teacher Dashboard</button></li>
                                <li><button onClick={() => navigate('/portal')} className="hover:text-white transition-colors">Student Portal</button></li>
                                <li><button onClick={() => navigate('/portal/parent')} className="hover:text-white transition-colors">Parent Portal</button></li>
                            </ul>
                        </div>
                    ...
                    <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <button className="text-gray-400 hover:text-white transition-colors text-sm font-bold bg-white/5 px-4 py-2 rounded-full hover:bg-white/10">Contact Support</button>
                        </div>
                    </div>
                </div>
            </footer>
