-- Fix the notification trigger to work with RLS policies
-- Using SECURITY DEFINER allows the trigger function to bypass RLS when inserting notifications
    ...
    IF v_student_id IS NOT NULL THEN
      ...
      LOOP
        ...
        EXCEPTION WHEN OTHERS THEN
          -- Silently ignore notification errors - don't block attendance recording
          NULL;
        END;
      END LOOP;
    END IF;
